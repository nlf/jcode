...
mod diagram_pane;
#[path = "ui_click_targets.rs"]
mod click_targets;
pub(crate) use click_targets::{
    diff_expand_target_from_screen, hover_target_from_screen,
    inline_image_body_target_from_screen, inline_image_expand_target_from_screen,
    link_target_from_screen, swarm_expand_target_from_screen, tool_expand_target_from_screen,
};
